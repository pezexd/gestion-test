        ...
        <tr>
            ...
            <table width="100%" style="">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="17" rowspan="2">
                            @if ($data->development_activity_image == null)
                                <p style="text-align: center">Sin Imagen</p>
                            @else
                            @php
                                $im1 = imagecreatefromwebp(storage_path().'/app/public/'.$data->development_activity_image);
                                imagejpeg($im1, './img/Reportes/Escuela_Padres/development_activity_image.jpeg', 100);
                            @endphp
                                <img style="width:100%;height: 612px;" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path().'/img/Reportes/Escuela_Padres/development_activity_image.jpeg'))}}">
                            @endif
                        </td>
                        <td colspan="17" rowspan="2">
                            @if ($data->evidence_participation_image == null)
                                <p style="text-align: center">Sin Imagen</p>
                            @else
                                @php
                                    $im2 = imagecreatefromwebp(storage_path().'/app/public/'.$data->evidence_participation_image);
                                    imagejpeg($im2, './img/Reportes/Escuela_Padres/evidence_participation_image.jpeg', 100);
                                @endphp
                                <img style="width:100%;height: 620px;" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path().'/img/Reportes/Escuela_Padres/evidence_participation_image.jpeg'))}}">
                            @endif
                        </td>
                    </tr>
                </tbody>
