...
class UpdatePsychopedagogicalLogBookRequest extends FormRequest
{
    /**
    ...
    {
        $this->merge([
            // 'psychopedagogical_logbook_id' => $this->route('psychopedagogicallogs'),
    ...
    {
        return [
            // 'psychopedagogical_logbook_id' => ['bail','required','numeric',Rule::exists(PsychopedagogicalLogbook::class,'id,deleted_at,NULL')],
    ...
    {
        return [
            // 'psychopedagogical_logbook_id' => 'BITÁCORA PSICOPEDAGOGICA',
